...
extension SCompoundUnit {
    public func addUnitDescription(to attrStr: NSMutableAttributedString) {
        for (unit, power) in baseUnitToPower {
            ...
            attrStr.append(NSAttributedString(string: String(power), attributes: [.font: smallerResultFont, .baselineOffset: scaled(22), .foregroundColor: #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)]))
        }
    }
}

let resultFont = UIFont(name: "CourierNewPSMT", size: scaled(56))!
let smallerResultFont = UIFont(name: "CourierNewPSMT", size: scaled(42))!
